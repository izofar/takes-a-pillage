...
public abstract class ModFeatures {
    ...
    public static final RegistryObject<Feature<NoneFeatureConfiguration>> MOB_FEATURE_SOLDIER = MODDED_FEATURES.register("mob_feature_soldier", () -> new MobFeature(ModLists::get_bastille_list));
    public static final RegistryObject<Feature<NoneFeatureConfiguration>> MOB_FEATURE_CAPTIVE = MODDED_FEATURES.register("mob_feature_captive", () -> new MobFeature(ModLists::get_captive_list));
