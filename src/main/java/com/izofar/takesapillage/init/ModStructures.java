...
public abstract class ModStructures {
    ...
    public static final RegistryObject<StructureFeature<JigsawConfiguration>> PILLAGER_STRUCTURE = MODDED_STRUCTURES.register("pillager_structure", () -> new PillagerStructure(ModJigsawConfiguration.CODEC));
