...
public class ModItems {
    ...
    public static final Item BASTILLE_BLUES = new RecordItem(4, ModSoundEvents.BASTILLE_BLUES, new FabricItemSettings().group(CreativeModeTab.TAB_MISC).stacksTo(1).rarity(Rarity.RARE), 3968);
