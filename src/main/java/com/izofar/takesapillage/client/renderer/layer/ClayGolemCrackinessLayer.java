...
public class ClayGolemCrackinessLayer extends RenderLayer<ClayGolem, ClayGolemModel> {
    private static final Map<IronGolem.Crackiness, ResourceLocation> resourceLocations = ImmutableMap.of(IronGolem.Crackiness.LOW, new ResourceLocation(TakesAPillageMod.MOD_ID, "textures/entity/clay_golem/clay_golem_crackiness_low.png"), IronGolem.Crackiness.MEDIUM, new ResourceLocation(TakesAPillageMod.MOD_ID, "textures/entity/clay_golem/clay_golem_crackiness_medium.png"), IronGolem.Crackiness.HIGH, new ResourceLocation(TakesAPillageMod.MOD_ID, "textures/entity/clay_golem/clay_golem_crackiness_high.png"));
