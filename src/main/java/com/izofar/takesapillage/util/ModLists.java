...
public abstract class ModLists {
    ...
    public static void setupEntityLists() {
        PILLAGER_CAMP_LIST = WeightedRandomList.create(ImmutableList.of(new MobWeightedEntry(EntityType.PILLAGER, 15), new MobWeightedEntry(ModEntityTypes.SKIRMISHER.get(), 12), new MobWeightedEntry(ModEntityTypes.ARCHER.get(), 8), new MobWeightedEntry(EntityType.VINDICATOR, 5), new MobWeightedEntry(EntityType.WITCH, 3), new MobWeightedEntry(EntityType.EVOKER, 1)));
        ...
        BASTILLE_LIST = WeightedRandomList.create(ImmutableList.of(new MobWeightedEntry(ModEntityTypes.LEGIONER.get(), 15), new MobWeightedEntry(ModEntityTypes.SKIRMISHER.get(), 12), new MobWeightedEntry(ModEntityTypes.ARCHER.get(), 8), new MobWeightedEntry(EntityType.PILLAGER, 7), new MobWeightedEntry(EntityType.VINDICATOR, 5), new MobWeightedEntry(EntityType.WITCH, 4), new MobWeightedEntry(EntityType.EVOKER, 1)));
        ...
        VillagerHostilesSensor.ACCEPTABLE_DISTANCE_FROM_HOSTILES = ImmutableMap.<EntityType<?>, Float>builder().put(EntityType.DROWNED, 8.0F).put(EntityType.EVOKER, 12.0F).put(EntityType.HUSK, 8.0F).put(EntityType.ILLUSIONER, 12.0F).put(EntityType.PILLAGER, 15.0F).put(ModEntityTypes.ARCHER.get(), 15.0F).put(ModEntityTypes.SKIRMISHER.get(), 15.0F).put(ModEntityTypes.LEGIONER.get(), 15.0F).put(EntityType.RAVAGER, 12.0F).put(EntityType.VEX, 8.0F).put(EntityType.VINDICATOR, 10.0F).put(EntityType.ZOGLIN, 10.0F).put(EntityType.ZOMBIE, 8.0F).put(EntityType.ZOMBIE_VILLAGER, 8.0F).build();
    }
